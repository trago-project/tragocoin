...
Only requiring some minor changes is tragocoin.cpp.
...
Changes to tragocoin.cpp
----------------------
tragocoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
