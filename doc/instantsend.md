...
This mechanism has been integrated into Bitcore-Node-tragocoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/tragocoincoin/insight-api-tragocoin#web-socket-api](https://github.com/tragocoincoin/insight-api-tragocoin#web-socket-api) 
* API: [https://github.com/tragocoincoin/insight-api-tragocoin#instantsend-transactions](https://github.com/tragocoincoin/insight-api-tragocoin#instantsend-transactions) 
...
By default, the tragocoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the tragocoin Core daemon:
