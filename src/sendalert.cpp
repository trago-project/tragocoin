...
2. run tragocoind with -printalert or -sendalert like this:
   /path/to/tragocoind -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://tragocoincoin.io";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/tragocoin Core:0.12.0.58/"));
