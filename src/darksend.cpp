...
{
    if(fLiteMode) return; // ignore all tragocoin related functionality
...
/*
    ...
    allow endless transaction that would bloat tragocoin and make it unusable. To
...
{
    if(fLiteMode) return; // disable all tragocoin specific functionality
    ...
    RenameThread("tragocoin-privatesend");
