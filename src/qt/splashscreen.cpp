    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText       = tr("tragocoin Core");
    ...
    QString copyrightTexttragocoin   = QChar(0xA9)+QString(" %1 ").arg(COPYRIGHT_YEAR) + QString(tr("The tragocoin Core developers"));
    ...
    pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace+12,copyrightTexttragocoin);
