    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("tragocoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a tragocoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and tragocoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About tragocoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about tragocoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for tragocoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your tragocoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified tragocoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a tragocoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the tragocoin Core help message to get a list with possible tragocoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("tragocoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to tragocoin network", "", count));
}
...
{
    QString strTitle = tr("tragocoin Core"); // default title
    ...
    // Append title to "tragocoin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
